...
function FooterSocial() {
  return (
    <footer
      className="degrade-to-bot-black-secondary full gap-y-[42px] font-secondFont text-left text-paragraph4 bg-bgSectionDark text-lighter flex flex-col py-[26px] phone3:py-[48px] justify-between items-center bg-cover bg-center bg-no-repeat"
