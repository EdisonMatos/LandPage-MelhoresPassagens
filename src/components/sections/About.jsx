...
export default function About() {
  ...
  return (
    <SectionArea
      id="about"
      className="degrade-to-bot-black-secondary pt-[155px] desktop1:pt-[250px]"
      paddingbot={false}
    >
      <SectionWrapper className="flex desktop1:mt-[120px] flex-col desktop1:flex-row-reverse gap-[40px] desktop1:gap-x-[40px] desktop2:gap-0 desktop1:justify-between">
